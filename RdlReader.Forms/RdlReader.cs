...
namespace Majorsilence.Reporting.RdlReader
{
    ...
    public partial class RdlReader : IMessageFilter
    {
        ...
        private void menuFileClose_Click(object sender, Majorsilence.Forms.MouseEventArgs e)
        {
        ...
        private void menuFileExit_Click(object sender, Majorsilence.Forms.MouseEventArgs e)
        {
            Environment.Exit(0);
        }

        private async void menuFileOpen_Click(object sender, Majorsilence.Forms.MouseEventArgs e)
        {
        ...
        private async void menuRecentItem_Click(object sender, Majorsilence.Forms.MouseEventArgs e)
        {
        ...
        private async void menuFilePrint_Click(object sender, Majorsilence.Forms.MouseEventArgs e)
        {
            MDIChild mc = this.ActiveMdiChild as MDIChild;
            if (mc == null)
                return;
        ...
        private async void menuFileSaveAs_Click(object sender, Majorsilence.Forms.MouseEventArgs e)
        {
            MDIChild mc = this.ActiveMdiChild as MDIChild;
            if (mc == null)
                return;
        ...
        private void menuHelpAbout_Click(object sender, Majorsilence.Forms.MouseEventArgs ea)
        {
            DialogAbout dlg = new DialogAbout();
            dlg.ShowDialog();
        }

        private void menuCopy_Click(object sender, Majorsilence.Forms.MouseEventArgs ea)
        {
            MDIChild mc = this.ActiveMdiChild as MDIChild;
        ...
        private async void menuFind_Click(object sender, Majorsilence.Forms.MouseEventArgs ea)
        {
            MDIChild mc = this.ActiveMdiChild as MDIChild;
            if (mc == null)
                return;
        ...
        private void menuSelection_Click(object sender, Majorsilence.Forms.MouseEventArgs ea)
        {
            MDIChild mc = this.ActiveMdiChild as MDIChild;
            if (mc == null)
                return;
        ...
        private void menuPLZoomTo_Click(object sender, Majorsilence.Forms.MouseEventArgs e)
        {
            MDIChild mc = this.ActiveMdiChild as MDIChild;
            if (mc == null)
                return;
        ...
        private void menuPLActualSize_Click(object sender, Majorsilence.Forms.MouseEventArgs e)
        {
            MDIChild mc = this.ActiveMdiChild as MDIChild;
            if (mc != null)
                mc.Viewer.Zoom = 1;
        ...
        private void menuPLFitPage_Click(object sender, Majorsilence.Forms.MouseEventArgs e)
        {
            MDIChild mc = this.ActiveMdiChild as MDIChild;
            if (mc != null)
        ...
        private void menuPLFitWidth_Click(object sender, Majorsilence.Forms.MouseEventArgs e)
        {
            MDIChild mc = this.ActiveMdiChild as MDIChild;
            if (mc != null)
        ...
        private void menuPLSinglePage_Click(object sender, Majorsilence.Forms.MouseEventArgs e)
        {
            MDIChild mc = this.ActiveMdiChild as MDIChild;
            if (mc != null)
        ...
        private void menuPLContinuous_Click(object sender, Majorsilence.Forms.MouseEventArgs e)
        {
            MDIChild mc = this.ActiveMdiChild as MDIChild;
            if (mc != null)
        ...
        private void menuPLFacing_Click(object sender, Majorsilence.Forms.MouseEventArgs e)
        {
            MDIChild mc = this.ActiveMdiChild as MDIChild;
            if (mc != null)
        ...
        private void menuPLContinuousFacing_Click(object sender, Majorsilence.Forms.MouseEventArgs e)
        {
            MDIChild mc = this.ActiveMdiChild as MDIChild;
            if (mc != null)
        ...
        private void menuWndCascade_Click(object sender, Majorsilence.Forms.MouseEventArgs e)
        {
            this.LayoutMdi(MdiLayout.Cascade);
        }

        private void menuWndCloseAll_Click(object sender, Majorsilence.Forms.MouseEventArgs e)
        {
        ...
        private void menuWndTileH_Click(object sender, Majorsilence.Forms.MouseEventArgs e)
        {
            this.LayoutMdi(MdiLayout.TileHorizontal);
        }

        private void menuWndTileV_Click(object sender, Majorsilence.Forms.MouseEventArgs e)
        {
